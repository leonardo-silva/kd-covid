package com.ifnmg.dmelab.kdcovid.control;
...
public final class Covid19 {
    ...
    public enum AgeRange {
        YEARS_1TO15(27), YEARS_16TO30(28), YEARS_31TO45(29), YEARS_46TO60(30), YEARS_60PLUS(31);
    ...
    */
    public static Risk Screening(boolean[] answers) {
        ...
        // Output 7:
        if (answers[AgeRange.YEARS_60PLUS.getValue()] || !answers[Diseases.PRIOR_DISEASE_DWA.getValue()]) {
